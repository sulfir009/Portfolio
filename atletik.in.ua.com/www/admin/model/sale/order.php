...
class ModelSaleOrder extends Model {
	...
	public function getOrderProducts($order_id) {
		$query = $this->db->query("SELECT " . DB_PREFIX . "order_product.*, " . DB_PREFIX . "product.quantity as product_quantity FROM " . DB_PREFIX . "order_product LEFT JOIN " . DB_PREFIX . "product ON (" . DB_PREFIX . "order_product.product_id = " . DB_PREFIX . "product.product_id) WHERE order_id = '" . (int)$order_id . "'");
