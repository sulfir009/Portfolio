            ...
            if($menu['status']) {
                ...
                foreach ($top_items as $top_item) {
                                    ...
                                    if($widgets) {
                                        foreach ($widgets as $widget) {
                                            ...
                                            if ($category_info) {
                                                ...
                                                $link = $this->url->link('product/list', 'category=' . $top_item['category_id'] . '_' . $category_id);
                                                $w_cols = $widget['cols'];
                                                ...
                                                if($widget['show_child']) {
                                                    ...
                                                    foreach ($results as $result) {
                                                        $children[] = array(
                                                            'title' => $result['name'],
                                                            'link' => $this->url->link('product/list', 'category=' . $top_item['category_id'] . '_' . $category_id . '_' . $result['category_id'])
                                                        );
                                                    }
                                                }
                                    ...
                                    if($widgets) {
                                        foreach ($widgets as $widget) {
                                            if($widget['type'] == "category") {
                                                ...
                                                if ($category_info) {
                                                    $title = $category_info['name'];
                                                    $link = $this->url->link('product/list', 'category=' . $category_id);
                                                    $w_cols = $widget['cols'];
                                                    ...
                                                    if($widget['show_child']) {
                                                        ...
                                                        foreach ($results as $result) {
                                                            $children[] = array(
                                                                'title' => $result['name'],
                                                                'link' => $this->url->link('product/list', 'category=' . $category_id . '_' . $result['category_id'])
                                                            );
                                                        }
                                                    }
                    ...
                    if(isset($top_item['category_id']) && $top_item['sub_menu_content_type'] == 'category') {
                        $top_link = $this->url->link('product/list', 'category=' . $top_item['category_id']);
                    } else {
