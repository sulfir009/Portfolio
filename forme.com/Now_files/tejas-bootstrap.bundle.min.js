...
(function (global, factory) {
	...
	class Carousel extends BaseComponent {
		...
		_getConfig(config) {
			config = _extends({}, Default$9, Manipulator.getDataAttributes(this._element), typeof config === 'object' ? config : {});
	...
	class Collapse extends BaseComponent {
		...
		static collapseInterface(element, config) {
			...
			const _config = _extends({}, Default$8, Manipulator.getDataAttributes(element), typeof config === 'object' && config ? config : {});
	...
	*/
	...
	class Backdrop {
		...
		_getConfig(config) {
			config = _extends({}, Default$6, typeof config === 'object' ? config : {}); // use getElement() with the default "body" to get a fresh Element on each instantiation
