(() => {
    ...
    $(window).scroll((function() {
        if ($(this).scrollTop() > 0) $("header").addClass("header_sticky"); else $("header").removeClass("header_sticky");
    }));
    $(".product_items").slick({
        infinite: true,
        slidesToShow: 4,
        ...
        a.mask = {
            ...
            mask: function(c, g) {
                ...
                return g = a.extend({
                    ...
                    })).on("http://develov2.beget.tech/js/focus.mask", (function() {
                        if (!B.prop("readonly")) {
                            clearTimeout(b);
                            var a;
                    ...
                    })).on("http://develov2.beget.tech/js/blur.mask", v).on("http://develov2.beget.tech/js/keydown.mask", w).on("http://develov2.beget.tech/js/keypress.mask", x).on("http://develov2.beget.tech/js/input.mask paste.mask", (function() {
                        B.prop("readonly") || setTimeout((function() {
                            var a = A(!0);
                            B.caret(a), h();
                        }), 0);
                    })), e && f && B.off("http://develov2.beget.tech/js/input.mask").on("http://develov2.beget.tech/js/input.mask", u), 
                    A();
                }));
            }
        });
    ...
    function toggleFilter(filterId) {
        ...
        var filter = filterContent.previousElementSibling;
