...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
		...
		$filter_keys = ['filter_stock', 'filter_manufacturer', 'filter_category', 'filter_sku', 'filter_upc', 'filter_name', 'filter_price', 'filter_quantity', 'filter_status'];
		$filter_params = [];
		...
		foreach ($results as $result) {
			...
			$data['products'][] = [
				...
				'sku' => $result['sku'],
				'upc' => $result['upc'], // Додайте цю лінію
